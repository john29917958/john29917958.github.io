...
# Fun Quiz
Open the developer console again! I want you to use three variables: two assigns a string, another assigns an integer. You have to have the browser print `"I give myself 100 points today!"`.
