...
---
經常性收入四、五萬以上，高挑戰、高成就感的程式職缺供不應求，更因 COVID-19 引發遠端技術工作、遠端娛樂等「宅」型經濟的成長。不僅是現在，未來市場對「程式設計師」的需求將越來越高。我想進入程式產業，我想在家中透過筆電，就與全世界的人合作！但我不清楚軟體產業特性、不知程式如何運轉、不知如何團隊合作、不清楚學習路線、不知該如何少走彎路……
