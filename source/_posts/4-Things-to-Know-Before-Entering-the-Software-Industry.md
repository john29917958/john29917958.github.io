...
感覺與製造業差很多吧？製造業的流程通常可以被「標準化」大量生產，需要不斷投入原料趕出貨。軟體因為複雜度高，撰寫過程難被「標準化」，生產過程需要謹慎。但軟體一完成，可以直接被無限複製或服務全球。這也是製造業思維難以直接套用到軟體製作的其中一項原因吧？
製作軟體的關鍵是少量多餐、是分析及設計、是專業分工及測試。一來讓問題提早浮現，避免後面無止盡的災難發生；一來讓艱深的軟體工作可以被專業化、被高品質地完成；最後是避免在發佈後，大範圍影響到使用者，造成鉅額損失。
