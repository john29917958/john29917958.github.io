...
讓我給你一個例子: 今天有一位老師在幫一列身高不等的小學生排隊。老師想把學生的身高從最高排到最低。但問題是，這位老師該怎麼做呢? 首先，這位老師先走到隊伍最前面來比較頭兩位學生的身高。如果學生沒有由高排到低就幫兩位學生交換位置。接著老師會比較第二跟第三位、第三跟第四位……一直到最後兩位。如果中間有幫任何學生交換位置，老師就會再走到最前面從頭檢查一輪，直到有任何一輪結束後老師都沒有幫學生交換位置為止。簡單來說，這段演算法總共由這三個步驟組成:
