...
我想要你先看過上面這個陣列，裡面儲存了每位學生的身高。依照上面的「演算法」，我們應該先從第一跟第二位學生開始檢查。檢查之後發現，第二位學生竟然比第一位學生高! 於是我們幫這二位學生交換位置。接下來我們檢查第二位跟第三位學生，發現第三位竟然又比第二位學生高，於是我們又幫第二跟第三位學生交換位置。一直到第四跟第五位學生，我們總共做了 4 次交換位置的動作。如果我們用一個代數「n」來表示學生的數量，那排完第一輪學生之後，我們總共檢查了 4 次 = 5 - 1 次 = n - 1 次、交換了 4 次 = 5 - 1 次 = n - 1 次
